...
@Autonomous(name="DecodeAutoRedFrontOld", group="Decode")
public  class DecodeAutoRedFrontOld extends OpMode {
    private DcMotorEx launcher;
    // launcher velocities (tune to your hardware)
    double LAUNCHER_TARGET_VELOCITY = 1610.0;
    double LAUNCHER_MIN_VELOCITY = 1510.0;
    ...
    public void init_loop() {
        ...
        telemetry.addData("PRESS B, ", "IN ORDER TO SHOOT AN EXTRA THREE BALLS AFTER THEY ARE COLLECTED AT THE END OF AUTO, AND A TO UNDO THAT DECISION.");
    ...
    public void loop() {
        ...
        switch (autonomousState) {
            case DRIVEALITTLE:
                if (drive(DRIVE_SPEED, -60.0, DistanceUnit.INCH, 0.2)) {
                    resetDriveFlags();
            ...
            case POINT_TO_SHOOT:
                ...
                if(rotate(ROTATE_SPEED, 125, AngleUnit.DEGREES,1)){
                    frontLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    frontRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    backLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    backRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
            ...
            case RETURN_TO_MIDDLE:
                ...
                if (drive(DRIVE_SPEED, 36.0, DistanceUnit.INCH, 0.2)) {
                    resetDriveFlags();
                    autonomousState = AutonomousState.ROTATETOBALLS;
                }
                break;
            ...
            case DRIVETONEXTBALLSY:
                if (drive(DRIVE_SPEED, 20.0, DistanceUnit.INCH, 0.2)) {
                    resetDriveFlags();
                    autonomousState = AutonomousState.ROTATETOBALLS;
                }
                break;
            case ROTATETOBALLS:
                if (shootExtraMo == 2.0) {
                    if(rotate(ROTATE_SPEED, 90.0, AngleUnit.DEGREES,0.2)) {
                        frontLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                        frontRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                        backLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                        backRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    ...
                    if(rotate(ROTATE_SPEED, -270.0, AngleUnit.DEGREES,0.2)) {
                        frontLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                        frontRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                        backLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                        backRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
            ...
            case DRIVETONEXTBALLSX:
                if (shootExtraMo < 2.0) {
                    ...
                    topWheel.setPower(-0.3);
                    intakeMotor.setPower(1.0);
                    shotsToFire = 3;
                    if (drive(0.8, -48.0, DistanceUnit.INCH, 0.2)) {
                        resetDriveFlags();
                        if (shootExtraMo == 1.0) {
                            autonomousState = AutonomousState.READYNEXTBALLS;
                        } else {
                            autonomousState = AutonomousState.COMPLETE;
                        }
                    }
                } else {
                    if (drive(1.0, 18.0, DistanceUnit.INCH, 0.2)) {
                        resetDriveFlags();
                        autonomousState = AutonomousState.COMPLETE;
                    }
                }
                ...
                break;
            case READYNEXTBALLS:
                if (drive(1.0, 48.0, DistanceUnit.INCH, 0.2)) {
                    resetDriveFlags();
                    autonomousState = AutonomousState.TURNEXTRABALLS;
                }
            case TURNEXTRABALLS:
                if(rotate(ROTATE_SPEED, 270, AngleUnit.DEGREES,0.2)) {
                    frontLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    frontRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    backLeft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    backRight.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
                    resetDriveFlags();
                    shootExtraMo = 2.0;
                    LAUNCHER_MIN_VELOCITY -= 150.0;
                    LAUNCHER_TARGET_VELOCITY -= 150.0;
                    autonomousState = AutonomousState.LIMELIGHT;
                }
                break;
            case COMPLETE:
