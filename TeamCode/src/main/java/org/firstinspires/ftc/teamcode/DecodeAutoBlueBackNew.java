...
@Autonomous(name="DecodeAutoBlueBackNew", group="Decode")
    ...
    public void loop() {
        ...
        switch (autonomousState) {
            ...
            case NEXTBALL:
                ...
                if (driveModo == 5 && drive(1.0, -30.0, DistanceUnit.INCH, 0.5, 0)) {
                    driveModo = 6;
                    autonomousState = AutonomousState.POINT_TO_SHOOT;
                }
                ...
                if (driveModo == 10 && drive(0.8, 54.0, DistanceUnit.INCH, 0.5, 0)) {
                    driveModo = 11;
                }
                if (driveModo == 11) {
                    autonomousState = AutonomousState.COMPLETE;
